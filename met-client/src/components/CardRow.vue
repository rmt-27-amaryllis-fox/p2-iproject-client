...
export default {
    ...
    methods: {
        ...
        addFavouriteComponent() {
            console.log(this.painting.id);
            this.addFavourite(this.painting.id)
        },
        formatPrice(value) {
            let val = (value / 1).toFixed(2).replace('.', ',')
            return val.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ".")
...
<template>
    ...
    <div class="card my-4" style="width: 18rem;">
        <img style="width:300px;height:300px" id="center-cropped" class="card-img-top img-thumbnail img-fluid center-cropped" :src="painting.image"
            alt="Card image cap">
        <div class="card-body">
            ...
            <div style="display:flex;align-items:space-between">
                ...
                <button @click="addFavouriteComponent(value)" value="{{painting.id}}" type="button"
