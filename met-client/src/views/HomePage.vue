    ...
    <div class="row">
      ...
      <div class="col">
        <h4 class="text-white justify-content-center"
          style="background-color: rgba(0,0,0,0.5);font-family:monospace;margin:auto;text-align:center; font-size:15px;width: 50%;text-align: center;">
          You may purchase a replica of the artwork. All funds received from sales of replica will be used to conserve
          our collections at the museum</h4>
